...
export type GetPlaylistTracksQuery = { __typename?: 'Query', getPlaylistTracks: { __typename?: 'getPlaylistTracksResponse', id: string, title: string, coverImageUrl: string, authorId: string, tracks?: Array<{ __typename?: 'Track', id: string, title: string, singer?: string | null, starCast?: string | null, duration: string, coverImageUrl?: string | null, videoUrl?: string | null, audioFileUrl: string, hasLiked: boolean, authorId: string, createdAt?: string | null }> | null } };
