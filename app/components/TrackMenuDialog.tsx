                ...
                <div className="p-4 text-white">
                    ...
                    <div className="space-y-2">
                        <div className="p-3 cursor-pointer rounded-lg flex items-center gap-3 group">
                            ...
                            <span className="group-hover:scale-105 transition-transform select-none">Play Now</span>
                        </div>
                        <div className="p-3 cursor-pointer rounded-lg flex items-center gap-3 group">
                            ...
                            <span className="group-hover:scale-105 transition-transform select-none">Add to Queue</span>
                        </div>
                        <div className="p-3 cursor-pointer rounded-lg flex items-center gap-3 group">
                            <svg className="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
                            </svg>
                            <span className="group-hover:scale-105 transition-transform select-none">Like</span>
                        </div>
                        <div className="p-3 cursor-pointer rounded-lg flex items-center gap-3 group">
                            <svg className="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <span className="group-hover:scale-105 transition-transform select-none ">Share</span>
                        </div>
                        <div className="p-3 cursor-pointer rounded-lg flex items-center gap-3 group">
                            <svg className="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M21 15V6" />
                            ...
                            <span className="group-hover:scale-105 transition-transform select-none">Add to Playlist</span>
                        </div>
                        <div className="p-3 cursor-pointer rounded-lg flex items-center gap-3 group">
                            <svg className="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <span className="group-hover:scale-105 transition-transform select-none">View Album</span>
                        </div>
                        <div className="p-3 cursor-pointer rounded-lg flex items-center gap-3 group">
                            <svg className="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <span className="group-hover:scale-105 transition-transform select-none">View Artist</span>
                        </div>
                    </div>
                </div>
