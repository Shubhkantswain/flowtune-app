                ...
                <div className="flex flex-row justify-between items-center gap-4 mb-4">
                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        <div className="flex gap-1 sm:gap-2">
                            <button
                                onClick={() => scroll('left')}
                                className={`p-1 sm:p-2 rounded-full text-white transition-colors active:scale-95 ${canScrollLeft ? "opacity-100" : "opacity-30 cursor-not-allowed"}`}
                            ...
                            <button
                                ...
                                className={`p-1 sm:p-2 rounded-full text-white transition-colors active:scale-95 ${canScrollRight ? "opacity-100" : "opacity-30 cursor-not-allowed"}`}
