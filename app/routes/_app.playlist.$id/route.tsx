...
function ExplorePlaylistsPage() {
    ...
    const handleControll = (track: Track) => {
        ...
        if (isPlayingCurrentSong && initialized) {
            ...
            if (!initialized) {
                if (res?.tracks) {
                    initialize(res.tracks.filter((track): track is Track => track !== null));
                }
            }
                                    ...
                                    >
                                        ...
                                        <td>
                                            <div className="flex items-center gap-4">
                                                <div className="relative group/image" onClick={() => { handleControll(track) }}>
                                                    <img
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-sm text-gray-400 hover:text-[#fa586a] cursor-pointer">{track?.singer}</div>
                                                </div>
                                            </div>
                                        </td>
