            ...
            <div className="relative p-6">
              ...
              {musicLanguages.map((language) => (
                ...
                >
                  ...
                  <button
                    className={`focus:outline-none ${selectedLanguage == language.name ? "text-[#02fad5]" : ""}`}
                  >
                ...
                {((data ? data.language : "Hindi") !== selectedLanguage && !isLoading && selectedLanguage !== "") && (
                  <div className="p-4 mt-5">
                    <button
                      ...
                      className="w-full py-3 bg-[#02fad5] hover:bg-[#e04a5a] text-white font-medium rounded-lg transition-colors disabled:opacity-50"
                    >
