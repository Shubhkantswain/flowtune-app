    ...
    return (
        <>
            <div className="flex md:hidden items-center space-x-5">
                <button className={`hover:text-[#fa586a] transition-colors ${isActive("/") ? "text-[#fa586a]" : ""}`}>
                ...
                <button className={`hover:text-[#fa586a] transition-colors ${isActive("/explore") ? "text-[#fa586a]" : ""}`}>
                ...
                <button className={`hover:text-[#fa586a] transition-colors ${isActive("/my/library") ? "text-[#fa586a]" : ""}`}>
                ...
                <button className={`hover:text-[#fa586a] transition-colors ${isActive("/search") ? "text-[#fa586a]" : ""}`}>
