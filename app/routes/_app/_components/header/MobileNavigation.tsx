...
const MobileNavigation = () => {
    ...
    return (
        ...
        opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap border border-white">
                    ...
                    <button className={`hover:text-[#02fad5] transition-colors ${isActive("/") ? "text-[#02fad5]" : ""}`}>
        ...
        opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap border border-white">
                    ...
                    <button className={`hover:text-[#02fad5] transition-colors ${isActive("/explore") ? "text-[#02fad5]" : ""}`}>
        ...
        opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap border border-white">
                    ...
                    <button className={`hover:text-[#02fad5] transition-colors ${isActive("/my/library") ? "text-[#02fad5]" : ""}`}>
        ...
        opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap border border-white">
                    ...
                    <button className={`hover:text-[#02fad5] transition-colors ${isActive("/search") ? "text-[#02fad5]" : ""}`}>
        ...
        opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap border border-white">
                    ...
                    <button
                        ...
                        className="hover:text-[#02fad5] transition-colors"
                        ref={buttonRef}
                    >
