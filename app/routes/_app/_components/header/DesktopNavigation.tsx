...
function DesktopNavigation() {
    ...
    // Properly typed handleLinkClick function
    ...
    return (
        <nav className="hidden md:flex items-center space-x-11">
            <Link to={"/"} onClick={(e) => handleLinkClick(e, "/")}>
                <button className={`flex items-center ${isActive("/") ? "text-[#fa586a]" : "hover:text-[#fa586a]"} transition-colors`}>
            ...
            <Link to={"/explore"} onClick={(e) => handleLinkClick(e, "/explore")}>
                <button className={`flex items-center ${isActive("/explore") ? "text-[#fa586a]" : "hover:text-[#fa586a]"} transition-colors`}>
            ...
            <Link to={"/my/library"} onClick={(e) => handleLinkClick(e, "/my/library")}>
                <button className={`flex items-center ${isActive("/my/library") ? "text-[#fa586a]" : "hover:text-[#fa586a]"} transition-colors`}>
